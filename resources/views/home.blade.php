        ...
        <div id="" class="well">
          ...
          <div id="" class="well">
            ...
            @foreach ($madeChallenges as $madeChallenge)
              <li class="list-group-item">{{ 'You challenged - ' . $madeChallenge->opponent->name }}  |  <a class="btn btn-small" href="/match/{{ $madeChallenge->id }}">view</a></li>
            @endforeach
            </ul>
          </div>
          ...
          <div id="" class="well">
            ...
            @foreach ($receivedChallenges as $receivedChallenge)
              <li class="list-group-item">{{ $receivedChallenge->challenger->name . ' - challenged you  ' }}  |  <a class="btn btn-small" href="/match/{{ $receivedChallenge->id }}">view</a></li>
            @endforeach
            </ul>
          </div>
